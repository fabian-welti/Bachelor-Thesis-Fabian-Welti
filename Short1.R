...
short1_data_filtered$Returns[1] <- 0  # or NA if you prefer to keep it as NA
...
# Replace the first NA value in Returns_Put with 0 or leave as NA depending on your preference
short1_data_filtered$Returns_Put[1] <- 0  # or NA if you prefer to keep it as NA
...
short1_data_filtered$Returns_SPX[1] <- 0  # or NA if you prefer to keep it as NA
...
rownames(new_rows) <- c("Alpha", "Beta")
    ...
    # Use rbind to append the data, this assumes results_short1 is a data frame with Short1_75 as its column
...
rownames(new_rows) <- c("Alpha", "Beta")
    ...
    # Combine with the original results
    # Use rbind to append the data, this assumes results_short1 is a data frame with Put_Index as its column
